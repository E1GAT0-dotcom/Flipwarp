...
import {installProjectSettings} from '../lib/flipwarp/project-settings.js';
...
class GUI extends React.Component {
    componentDidMount () {
        ...
        installProjectSettings(this.props.vm);
...
const mapStateToProps = state => {
    ...
    return {
        ...
        packageModalVisible: state.scratchGui.modals.packageModal,
